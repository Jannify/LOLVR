...
namespace Edwon.VR.Gesture
{
    public class VRGestureGalleryGrid : MonoBehaviour
    {
        ...
        void GenerateTitle()
        {
            GameObject titleGO = Instantiate(titlePrefab, titleParent, true);
        ...
        void GenerateGestureGalleryGrid()
        {
            ...
            {
                GameObject galleryExampleGO = Instantiate(gallery.examplePrefab.gameObject, gridParent, true);
