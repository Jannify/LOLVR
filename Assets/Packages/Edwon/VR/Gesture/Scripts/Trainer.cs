...
namespace Edwon.VR.Gesture
{
    ...
    public class Trainer
    {
        ...
        {
            string gestureFileLocation = Config.STREAMING_ASSETS + Config.NEURAL_NET_PATH + recognizerName + "/Gestures/";
        ...
        public double[][] ReadAllData()
        {
            ...
            string gesturesFilePath = Config.STREAMING_ASSETS + Config.NEURAL_NET_PATH + recognizerName + "/Gestures/";
        ...
        public void SaveNeuralNetwork(double[] weights)
        {
            ...
            string filePath = Config.STREAMING_ASSETS + Config.NEURAL_NET_PATH + recognizerName + "/" + recognizerName + ".txt";
